...
// function CommonForm({action,buttontext
//     ,isBtnDisabled,formControls,btnType,
...
//                     focus:drop-shadow-lg focus-visible:outline-none 
...
//     }
//     return (
//         <form key={`form-${formData.id || new Date().getTime()}`} action={action}>
//             {/* {
